...
export const aboutData = {
  ...
  mission: "Our mission is to deliver high-quality lighting, electrical, and building material solutions that meet the evolving needs of modern commercial, industrial, infrastructure, and government projects. We are committed to supporting contractors, consultants, developers, and government entities with reliable products, technical expertise, innovative solutions, and responsive service. Through practical and cost-effective solutions, we aim to enhance safety, efficiency, functionality, and architectural appeal while meeting project requirements and industry standards. We strive to build long-term partnerships through consistent quality, timely delivery, professional support, and a strong commitment to customer satisfaction.",
  narrative: [
    ...
    "Our philosophy is simple: we go beyond trading. We provide technical engineering solutions. We bridge the gap between world-class international manufacturers and local project requirements, ensuring that consultants, MEP contractors, and developers receive the precise specified equipment, right on time, and fully compliant with Oman's regulatory standards."
  ],
  strengths: [
    {
